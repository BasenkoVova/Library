...
public class TestDateBook {
    ...
    public static final Book BOOK1 = new Book(USER_BOOK_ID_1, "Монах, що продав свій феррарі", "Робін Шарма", "2015");
    public static final Book BOOK2 = new Book(USER_BOOK_ID_2, "Найбагатша людина у Вавилоні", "Джордж Клейсон", "2017");
    public static final Book BOOK3 = new Book(ADMIN_BOOK_ID, "Стратегії геніїв", "Девід Йоффе, Майкл Кузумано", "2017");
